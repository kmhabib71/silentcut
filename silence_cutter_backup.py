...
class AudioCircularBuffer:
    ...
    def __init__(self, sample_rate=44100, max_size=1000):
        self.buffer = deque(maxlen=max_size)
...
class VideoPlaybackThread(QThread):
    """Thread for video playback with frame caching"""

    frame_ready = pyqtSignal(np.ndarray)
    frame_cache_stats = pyqtSignal(dict)
    frame_cache_miss = pyqtSignal()
    frame_cache_hit = pyqtSignal()
    frame_cache_clear = pyqtSignal()
    frame_cache_update = pyqtSignal()
    frame_cache_resize = pyqtSignal()
    frame_cache_reset = pyqtSignal()
    frame_cache_refresh = pyqtSignal()
    frame_cache_invalidate = pyqtSignal()
    frame_cache_flush = pyqtSignal()
    frame_cache_evict = pyqtSignal()
    frame_cache_purge = pyqtSignal()
    frame_cache_expire = pyqtSignal()
    frame_cache_revalidate = pyqtSignal()
    frame_cache_refresh_all = pyqtSignal()
    frame_cache_refresh_range = pyqtSignal()
    frame_cache_refresh_nearest = pyqtSignal()
    frame_cache_refresh_interval = pyqtSignal()
    frame_cache_refresh_batch = pyqtSignal()
    frame_cache_refresh_async = pyqtSignal()
    frame_cache_refresh_sync = pyqtSignal()
    frame_cache_refresh_threaded = pyqtSignal()
    frame_cache_refresh_parallel = pyqtSignal()
    frame_cache_refresh_sequential = pyqtSignal()
    frame_cache_refresh_periodic = pyqtSignal()
    frame_cache_refresh_continuous = pyqtSignal()
    frame_cache_refresh_on_demand = pyqtSignal()
    frame_cache_refresh_lazy = pyqtSignal()
    frame_cache_refresh_eager = pyqtSignal()
    frame_cache_refresh_prefetch = pyqtSignal()
    frame_cache_refresh_background = pyqtSignal()
    frame_cache_refresh_foreground = pyqtSignal()
    frame_cache_refresh_idle = pyqtSignal()
    frame_cache_refresh_active = pyqtSignal()
    frame_cache_refresh_passive = pyqtSignal()
    frame_cache_refresh_aggressive = pyqtSignal()
    frame_cache_refresh_conservative = pyqtSignal()
    frame_cache_refresh_balanced = pyqtSignal()
    frame_cache_refresh_optimal = pyqtSignal()
    frame_cache_refresh_smart = pyqtSignal()
    frame_cache_refresh_intelligent = pyqtSignal()
    frame_cache_refresh_adaptive = pyqtSignal()
    frame_cache_refresh_dynamic = pyqtSignal()
    frame_cache_refresh_responsive = pyqtSignal()
    frame_cache_refresh_proactive = pyqtSignal()
    frame_cache_refresh_reactive = pyqtSignal()
    frame_cache_refresh_predictive = pyqtSignal()
    frame_cache_refresh_anticipatory = pyqtSignal()
    frame_cache_refresh_preemptive = pyqtSignal()
    frame_cache_refresh_proactive = pyqtSignal()
    frame_cache_refresh_reactive = pyqtSignal()
    frame_cache_refresh_predictive = pyqtSignal()
    frame_cache_refresh_anticipatory = pyqtSignal()
